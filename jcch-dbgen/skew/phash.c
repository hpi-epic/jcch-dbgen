...
void init_skew() {
	init_phash(&phash_part, jcch_scale * jcch_tdefs[JCCH_PART].base);
	init_phash(&phash_supplier, jcch_scale * jcch_tdefs[JCCH_SUPP].base);
	init_phash(&phash_customer, jcch_scale * jcch_tdefs[JCCH_CUST].base);
	init_phash(&phash_orders, jcch_scale * jcch_tdefs[JCCH_ORDER].base);
}
